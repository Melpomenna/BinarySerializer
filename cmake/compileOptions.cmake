...
function(SetCompileOptionsCXX target)
    target_compile_options(${target} PRIVATE -std=c++20 -Wno-missing-exception-spec)
    if (${BS_ENABLE_GCOV})
        message(STATUS "Gcov enabled")
        target_compile_options(${target} PRIVATE -fprofile-instr-generate -fcoverage-mapping)
        target_link_options(${target} PRIVATE -fprofile-instr-generate -fcoverage-mapping)
...
function(SetCompileOptionsFuzzCXX target)
    target_compile_options(${target} PRIVATE -std=c++20 -fsanitize=fuzzer-no-link -Wno-missing-exception-spec)
